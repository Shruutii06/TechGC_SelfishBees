...
# New datasets added in Phase 2 data enrichment
DATASET_CONFIG["attendance_reference.csv"] = {
    "collection": "attendance",
    "text_cols":  ["event","sport","host"],
    "meta_cols":  ["year","total_matches","avg_attendance","total_attendance"],
    "description":"Historical attendance benchmarks for cricket and kabaddi events",
}
DATASET_CONFIG["kabaddi_wc_reference.csv"] = {
    "collection": "kabaddi",
    "text_cols":  ["event","host","winner","runner_up"],
    "meta_cols":  ["year"],
    "description":"Kabaddi World Cup historical editions",
}
DATASET_CONFIG["pkl_teams_reference.csv"] = {
    "collection": "kabaddi",
    "text_cols":  ["team","city","state","owner"],
    "meta_cols":  ["titles","event"],
    "description":"Pro Kabaddi League teams and franchises",
}
